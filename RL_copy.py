...
from environment_copy_copy import FlyEnv
...
frames_per_batch = 8 # nb of interactions with the environment
# For a complete training, bring the number of frames up to 1M
total_frames = 80 # total nb of interactions with environment
...
if __name__=='__main__':
    ...
    for i, tensordict_data in enumerate(collector):
        ...
        for _ in range(num_epochs):
            ...
            advantage_module(tensordict_data.reshape(-1))
